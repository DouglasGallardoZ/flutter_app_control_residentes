...
class AccessHistoryLoaded extends AccessHistoryState {
  final List<AccessLog> logs;
  AccessHistoryLoaded(this.logs);
}

class AccessHistoryError extends AccessHistoryState {
  final String message;
  AccessHistoryError(this.message);
}
